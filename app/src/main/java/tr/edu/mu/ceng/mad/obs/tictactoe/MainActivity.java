package tr.edu.mu.ceng.mad.obs.tictactoe;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        outState.putBoolean("player1 turn",player1Turn);
        byte[] boardSingle = new byte[90];
        for (int i=0; i<3; i++){
            for (int j =0; i<3;i++) {
    ...
    protected void onRestoreInstanceState(@NonNull Bundle savedInstanceState) {
        ...
        player1Turn = savedInstanceState.getBoolean("player1 turn");
